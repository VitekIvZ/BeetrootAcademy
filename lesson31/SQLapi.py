...
class DBQueryHandler:
    ...
    def select(self, table_name, columns="*", condition=None, join_clause=None, group_by=None, order_by=None):
        """
    ...
    :order_by: Стовпець для сортування (наприклад, "department_id")
    :join_clause: Рядок з умовою JOIN (наприклад, "JOIN departments ON employees.department_id = departments.id")
